...
\begin{flushleft}
	...
	\begin{enumerate}
		...
		\begin{enumerate}[label=(\alph*)]
			\item lvcreate -L 5G -n volume\_name  lv\_name  %correct
			\item lvextend -L +5G  lv\_name  %correct
			\item lvreduce -L 5G  lv\_name  %correct
			\item lvremove lv\_name  %correct
		\end{enumerate}
		\bigskip
		\bigskip	
